...
mt.curr = {
    ...
    , in_details: function (ret) {
        ...
        if ($('#dtags .ico').length > 0) {
            ...
            if (ret.lat && ret.lat.substr(0, 1) != '0' && $('.ico3').length > 0) {
                $('.ico3').html('<div class="r2">' + $('.ico3').html().substr(0, 20) + '</div>').on('click', function () {
                    location = '../../plus/map-point={0}&name={1}&addr={2}.htm'/*tpa=http://m.maitao.com/plus/map?point={0}&name={1}&addr={2}*/.format(
        ...
        if (ret.supp_id) {
            mt.t.jsonp('partner/detail', { partner_id: ret.supp_id }, function (ret2) {
                ...
                $('.pnbox').on('click', function () {
                    location = 'http://m.maitao.com/partner/{0}'.format(ret.supp_id);
        ...
        if (ret.can_customized) {
            $('#ddz').removeClass('none').click(function () {
                location = '../../plus/actcustom/index.htm'/*tpa=http://m.maitao.com/plus/actcustom/*/ + mt.t.id;
    ...
    , in_mark: function () {
        if (mt.t.cookie.get('uid')) {
            ...
            $('.ic_mark').click(function () {
                location = '../../guest/login.htm'/*tpa=http://m.maitao.com/guest/login*/;
            });
        }
    }
    , in_taocan: function () {
    ...
    , goto_join: function (gro) {
        ...
        if (gro.has_lock) {
            if (!mt.t.cookie.get('uid')) {
                location = '../../guest/login-from=.htm'/*tpa=http://m.maitao.com/guest/login?from=*/ + encodeURIComponent(location.pathname + location.search);
                return;
            }
    ...
    , goto_join2: function (gro) {
        location = 'http://m.maitao.com/order/{0}/{1}?gro_id={2}&date={3}&from={4}'.format(
    ...
    , load_cmt: function () {
        ...
        s += '<a href="http://m.maitao.com/user/{7}"><img class="left av" src="{0}" /></a>';
    ...
    , in_cmt: function () {
        ...
        $('.cdzan').off('click').on('click', function () {
            ...
            if (!uid) {
                location = '../../guest/login.htm'/*tpa=http://m.maitao.com/guest/wxlogin*/;
                return;
            }
            var data = {
    ...
    , load_qa: function () {
        ...
        s += '<a href="http://m.maitao.com/user/{0}"><img class="left av" src="{1}" />';
        s += '<i class="left">{2}</i></a>';
        s += '<i class="f12 c6">{3}</i></div>';
        s += '<div class="qcon goto" data-href="../../plus/qa/{4}-act_query_id={5}.htm"/*tpa=http://m.maitao.com/plus/qa/{4}?act_query_id={5}*/>{6}</div>';
        s += '{7}</div>';

        var s2 = '<div class="abox goto" data-href="../../plus/qa/{3}-act_query_id={4}.htm"/*tpa=http://m.maitao.com/plus/qa/{3}?act_query_id={4}*/>';
