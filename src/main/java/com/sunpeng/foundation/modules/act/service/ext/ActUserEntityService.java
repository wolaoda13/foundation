 ...
 */
package com.sunpeng.foundation.modules.act.service.ext;
...
import com.sunpeng.foundation.modules.act.utils.ActUtils;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.sunpeng.foundation.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.sunpeng.foundation.modules.sys.entity.User(null, userId)))){
